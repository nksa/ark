...
import com.test.service.ContactLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.test.service.impl.ContactLocalServiceImpl}.
 * </p>
 *
 * @author nxant
...
public abstract class ContactLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.test.service.ContactLocalServiceUtil} to access the contact local service.
	 */
	...
	@Override
	public ContactImageBlobModel getImageBlobModel(Serializable primaryKey)
		throws SystemException {
		Session session = null;

		try {
			session = contactPersistence.openSession();

			return (com.test.model.ContactImageBlobModel)session.get(ContactImageBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw contactPersistence.processException(e);
		}
		finally {
			contactPersistence.closeSession(session);
		}
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.test.model.Contact",
			contactLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.test.model.Contact");
	}
