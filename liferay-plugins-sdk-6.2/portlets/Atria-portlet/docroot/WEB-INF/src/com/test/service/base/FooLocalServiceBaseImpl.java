...
public abstract class FooLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 */
	@Override
	public Foo createFoo(long personId) {
		return fooPersistence.create(personId);
	}
	...
	@Override
	public Foo deleteFoo(long personId) throws PortalException, SystemException {
		return fooPersistence.remove(personId);
	}
	...
	@Override
	public Foo fetchFoo(long personId) throws SystemException {
		return fooPersistence.fetchByPrimaryKey(personId);
	}
	 ...
	 */
	@Override
	public Foo getFoo(long personId) throws PortalException, SystemException {
		return fooPersistence.findByPrimaryKey(personId);
	}
	...
	@Override
	public FooImageBlobModel getImageBlobModel(Serializable primaryKey)
		throws SystemException {
		Session session = null;

		try {
			session = fooPersistence.openSession();

			return (com.test.model.FooImageBlobModel)session.get(FooImageBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw fooPersistence.processException(e);
		}
		finally {
			fooPersistence.closeSession(session);
		}
	}
